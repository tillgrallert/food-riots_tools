...
func_period <- function(x,y){v_pricesWheat[v_pricesWheat$date >= x & v_pricesWheat$date <= y,]}
## specify period
v_dateStart <- as.Date("1908-01-01")
v_dateStop <- as.Date("1916-12-31")
v_wheatKilePeriod <- func_period(v_dateStart,v_dateStop) 
