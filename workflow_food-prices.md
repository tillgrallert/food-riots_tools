...
3. normalize non-metrical measures: this is done with a [parameter file](xslt/tei-measure_parameters.xsl) that records localised and dated information on conversion rates between different units.
